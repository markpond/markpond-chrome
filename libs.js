    ...
    var settings = jQuery.extend({
      ...
      inputPadding: 6*2
		...
		this.each(function() { 
			...
			var markup = '<div id="'+id+'_tagsinput" class="tagsinput" data-placeholder="Tags (seperateed by commas)"><div class="tagsinput-add-container" id="'+id+'_addTag"><div class="tagsinput-add fui-plus-16"></div>';
